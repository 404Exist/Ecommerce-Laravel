...
@section('content')
  ...
  <div class="container-fluid">
    <div class="card">
      {!! Form::open(['url' => admin_url('products'), 'method' => 'patch', 'files' => true, 'id' => 'product_form']) !!}
      <div class="card-header">
        <a class="btn btn-primary">Save <span><i class="fa fa-save"></i></span> </a>
        <a class="btn btn-success" onclick="productCrud(this, 'POST', '{{ route('products.update', $product->id) }}','',false )">Save and continue <span><i class="fa fa-save"></i></span></a>
        ...
        <a class="btn btn-danger" onclick="productCrud(this, 'DELETE', '{{ admin_url('products/destroy')}}', {product : {{$product->id}} })">Delete <span><i class="fa fa-trash"></i></span></a>
        <div id="validation">
          <ul style="margin: 0">
      ...
      <div class="card-body">
        ...
        <ul class="nav nav-tabs" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#related_product">Related Products <i
                class="fa fa-list"></i></a>
          </li>
        </ul>
        ...
        <div class="tab-content">
          @include('admin.products.form.info', [$product])
          @include('admin.products.form.department', [$product])
          @include('admin.products.form.setting', [$product])
          @include('admin.products.form.media', [$product])
          @include('admin.products.form.shipping', [$product])
          @include('admin.products.form.additional_data', [$product])
          @include('admin.products.form.related_product', [$product])
        </div>
      </div>
      {!! Form::close() !!}
    </div>
